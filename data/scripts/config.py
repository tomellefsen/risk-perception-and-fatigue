...
SLICES = [
    ...
    {
        'name': 'P3_Troisième_vague_et_vaccination',
        'start': '2021-03-01',
        'end': '2021-07-17',
        'events': [
    ...
    {
        'name': 'P4_variant_delta_et_passeport_vaccinal',
        'start': '2021-07-18',
        'end': '2021-11-30',
        'events': [
    ...
    {
        'name': 'P5_Vague_omicron_et_confinement_hivernal',
        'start': '2021-12-01',
        'end': '2022-03-31',
        'events': [
    ...
    {
        'name': 'P6_Post-omicron_et_fin_urgence_sanitaire',
        'start': '2022-04-01',
